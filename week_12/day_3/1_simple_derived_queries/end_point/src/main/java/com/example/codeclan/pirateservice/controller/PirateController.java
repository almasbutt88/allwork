...
public class PirateController {
    ...
    public ResponseEntity<List<Pirate>> getPirateByFirstName(@RequestParam(name = "firstname") String firstname){
        return new ResponseEntity<>(pirateRepository.findPiratesByFirstName(firstname),HttpStatus.OK);
    }

    @GetMapping(value = "/pirates/getbylastname")
    public ResponseEntity<List<Pirate>> getPirateByLastName(@RequestParam(name = "firstname"){
        String firstname;
        return new ResponseEntity<>(pirateRepository.findPiratesByFirstName(firstname), HttpStatus.OK)};

    @GetMapping(value = "/pirates/getbyage")
    public ResponseEntity<List<Pirate>> getPirateByAge(@RequestParam(name = "age" )){
        return new ResponseEntity<>(pirateRepository.findPiratesByAge(age), HttpStatus.Ok)};
